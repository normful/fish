var CreateGroup, Main, Robot, ToggleGreed, gameParameters, socket, user, validateParameters;

Robot = function(name, greed) {
  this.name = name;
  this.greed = greed;
};
